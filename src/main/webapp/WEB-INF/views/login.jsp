    ...
    <script>
        async function login(event) {
            ...
            if (response.ok) {
                ...
                document.getElementById("error-message").textContent = "Đăng nhập thất bại. Vui lòng kiểm tra lại tài khoản.";
            }
        }
    </script>
</head>
<body>
    <div class="login-container">
        ...
        <a class="signup-link" href="${pageContext.request.contextPath}/auth/signup">Bạn chưa có tài khoản? Đăng ký tại đây</a>
